...
늦지 않게 와주세요!`,
  ...
  admin_new_request: {
    subject: "[푸르른 스튜디오] 새 예약 신청이 들어왔어요",
    body: `새 예약 신청이 들어왔어요.
